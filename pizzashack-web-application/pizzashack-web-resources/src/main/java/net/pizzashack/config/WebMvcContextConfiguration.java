...
import net.pizzashack.interceptor.SecurityHandlerInterceptor;
import net.pizzashack.support.SessionAttributeProcessor;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "net.pizzashack" })
