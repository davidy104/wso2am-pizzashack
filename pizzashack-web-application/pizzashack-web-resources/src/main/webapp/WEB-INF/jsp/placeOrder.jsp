...
<body>
	...
	<form:form action="/order/place" cssClass="well" commandName="order"
		method="POST">
		<div id="control-group-pizzaType" class="control-group">
			...
			<div class="controls">
				...
				<form:errors id="error-pizzaType" path="pizzaType" cssClass="help-inline" />
			</div>
		</div>
		<div id="control-group-customerName" class="control-group">
			<label for="order-customerName">
				<spring:message code="order.label.customerName" />:</label>

			<div class="controls">
				<form:input id="order-customerName" path="customerName" />
				<form:errors id="error-customerName" path="customerName" cssClass="help-inline" />
			</div>
		</div>

		<div id="control-group-customerEmail" class="control-group">
			<label for="order-customerEmail">
				<spring:message code="order.label.customerEmail" />:</label>

			<div class="controls">
				<form:input id="order-customerEmail" path="customerEmail" />
				<form:errors id="error-customerEmail" path="customerEmail" cssClass="help-inline" />
			</div>
		</div>

		<div id="control-group-address" class="control-group">
			<label for="order-address">
				<spring:message code="order.label.address" />:</label>

			<div class="controls">
				<form:textarea id="order-address" path="address" />
				<form:errors id="error-address" path="address" cssClass="help-inline" />
			</div>
		</div>

		<div id="control-group-quantity" class="control-group">
			<label for="order-quantity">
				<spring:message code="order.label.quantity" />:</label>

			<div class="controls">
				<form:input id="order-quantity" path="quantity" />
				<!--
				<form:errors id="error-quantity" path="quantity" cssClass="help-inline" />
				 -->
			</div>
		</div>

		<div id="control-group-creditCardNumber" class="control-group">
			<label for="order-creditCardNumber">
				<spring:message code="order.label.creditCardNumber" />:</label>

			<div class="controls">
				<form:input id="order-creditCardNumber" path="creditCardNumber" />
				<form:errors id="error-creditCardNumber" path="creditCardNumber" cssClass="help-inline" />
			</div>
		</div>
		...
		<div class="form-buttons">
			...
			<button id="add-order-button" type="submit" class="btn btn-primary">
				<spring:message code="order.checkout.button.label" />
			</button>
		</div>
	</form:form>
</body>
